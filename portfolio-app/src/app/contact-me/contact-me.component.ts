...
export class ContactMeComponent {
  ...
  text={
    EN:{placeholderName:'Your name',placeholderEmail:'Your e-mail',placeholderMessage:'Your message',errorName:'Please enter your name.',errorEmail:'Please enter a valid e-mail address.',errorMessage:'Please enter a message.',errorPrivacy:'Please confirm the privacy policy.',privacyLabelPart1:`I've read the`,privacyLabelPart2:`privacy policy`,privacyLabelPart3:`and agree to the processing of my data as outlined.`,btnSend:'Send',feedbackFillAll:'Please fill out all fields correctly.',feedbackSent:'Your message has been sent successfully!',feedbackTest:'Test mode active. No mail was actually sent.',feedbackErrorSend:'Unfortunately, there was a problem sending your message.',introTitle:'Let us build something meaningful.',introText:`I’m open to software engineering opportunities where frontend craft, backend thinking and data come together. If you are building a thoughtful digital product, I would be glad to hear about it.`,labelEmail:'E-mail:',labelPhone:'Tel:'},
